...
public interface Errors {
    ...
    DiagnosticFactory0<KtExpression> ANNOTATION_ARGUMENT_KCLASS_LITERAL_WITH_PROJECTION = DiagnosticFactory0.create(WARNING);
    DiagnosticFactory0<KtExpression> ANNOTATION_ARGUMENT_KCLASS_LITERAL_WITH_PROJECTION_ERROR = DiagnosticFactory0.create(ERROR);
