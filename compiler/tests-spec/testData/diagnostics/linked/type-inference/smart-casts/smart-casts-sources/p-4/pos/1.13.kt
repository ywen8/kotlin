    ...
    if (x is Interface1) {
        if (<!SENSELESS_COMPARISON!>x != null<!>) {
            ...
            x.apply {
                ...
                equals(this)
                itest()
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>.equals(x)
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>.itest()
            }
            x.also {
