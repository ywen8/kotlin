...
fun <T> T?.case_5() {
    if (this is Interface1) {
        if (<!SENSELESS_COMPARISON!>this != null<!>) {
            <!DEBUG_INFO_EXPRESSION_TYPE("T!! & T? & Interface1"), DEBUG_INFO_EXPRESSION_TYPE("T?")!>this<!>
            <!DEBUG_INFO_EXPRESSION_TYPE("T?"), DEBUG_INFO_EXPRESSION_TYPE("Interface1"), DEBUG_INFO_SMARTCAST!>this<!>.equals(this)
            <!DEBUG_INFO_EXPRESSION_TYPE("T?"), DEBUG_INFO_EXPRESSION_TYPE("Interface1"), DEBUG_INFO_SMARTCAST!>this<!>.itest1()

            <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>equals<!>(this)
            <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>itest1<!>()
            apply {
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>
                equals(this)
                itest1()
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>.equals(this)
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}"), DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>this<!>.itest1()
            }
            also {
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>it<!>
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>it<!>
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>it<!>.itest1()
                <!DEBUG_INFO_EXPRESSION_TYPE("{T?!! & Interface1}")!>it<!>.equals(it)
            }
        }
    }
}
...
fun <T> T.case_65() {
    if (this is Interface1?) {
        if (this is Interface2?) {
            if (this != null) {
                <!DEBUG_INFO_EXPRESSION_TYPE("T & T!! & Interface1 & Interface2"), DEBUG_INFO_EXPRESSION_TYPE("T")!>this<!>
                <!DEBUG_INFO_EXPRESSION_TYPE("T"), DEBUG_INFO_EXPRESSION_TYPE("Interface1"), DEBUG_INFO_SMARTCAST!>this<!>.equals(<!UNRESOLVED_REFERENCE!>x<!>)
                apply {
                    <!DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}"), DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}")!>this<!>
                    <!DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}"), DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}")!>this<!>.equals(this)
                }
                also {
                    <!DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}")!>it<!>
                    <!DEBUG_INFO_EXPRESSION_TYPE("{T!! & Interface1 & Interface2}")!>it<!>.equals(it)
                }
            }
        }
    }
